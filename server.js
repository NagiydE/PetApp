...
var app      = express();
var port     = process.env.PORT || 4321; // whatever environment settings the client has set up will be priortized, it will run on our set port.
...
app.use(session({
    secret: 'rcbootcamp2024', // session secret
    resave: true,
